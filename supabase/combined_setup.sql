-- ============================================================
-- Combined Supabase schema for admissions-assistant
-- Generated from supabase/migrations/*.sql (in git order).
-- Paste this into the Supabase SQL Editor for a FRESH project.
-- Do NOT run against a project that already had 'supabase db push'.
-- ============================================================


-- >>>>>>>>>> supabase/migrations/202607160001_initial_backend.sql <<<<<<<<<<
...
-- >>>>>>>>>> supabase/migrations/202607160002_transcript_pipeline.sql <<<<<<<<<<
...
-- >>>>>>>>>> supabase/migrations/202607160003_course_recommendation_engine.sql <<<<<<<<<<
